...
class EnhancedSwinTransformer(SwinTransformer):
    ...
    def __init__(
        ...
        spatial_dims: int = 3,
        downsample="merging",
        use_v2=False,                        # Match main SwinUNETR default
        use_multi_scale_attention: bool = False,  # Match main SwinUNETR default
        use_adaptive_window: bool = False,        # Match main SwinUNETR default
        use_enhanced_v2_blocks: bool = False,     # Match main SwinUNETR default
        multi_scale_window_sizes: List[int] = [7, 5, 3],
    ):
        super().__init__(
...
class SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        use_v2: bool = False,  # Default to False for vanilla compatibility
        # New parameters for SwinUNETRPlus (all disabled by default for vanilla compatibility)
        use_multi_scale_attention: bool = False,
        use_adaptive_window: bool = False,
